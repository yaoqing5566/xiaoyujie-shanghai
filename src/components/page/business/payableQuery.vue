  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-date"></i> 应付款查询</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
  ...
  export default {
    ...
    methods: {
      exportPayable(){
        ...
        window.open("/Views/admin/business/exportPayableQuery.aspx?type=1&ids="+ids)
      },
      ...
      getData(){
        ...
        $_get('/Views/admin/business/payableQuery.aspx?state=0&startTime='+startTime+"&endTime="+endTime+"&department="+_this.select.department).then(function (response) {
          if(response.code==1){
